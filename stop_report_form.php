  ...
  <div class="row content">
	...
	<form id="get_stop_report">
      <ul class="nav nav-pills nav-stacked" style="margin-top:.2vh;">
        ...
        <li><a>
            <input type="button" id="submit" class="btn btn-danger" onclick="return validateForm()" style="margin-left: 2vw;" value="Get Report" /><input onclick='window.close();' class="btn btn-danger" type="button" value="Back" style="float:left;" />
          </a>
        </li>
      </ul>
	</form>
...
<script>
		...
		function validateForm() {
			...
			return false;
				...
				$("#error").show();
				var data = $("#get_stop_report").serialize();//alert(data);
				$.ajax({
    ...
    <div class="col-sm-9">
		<div class="ScrollStyle" id="report_data" style="background-image: url('image/bgmap.png');
